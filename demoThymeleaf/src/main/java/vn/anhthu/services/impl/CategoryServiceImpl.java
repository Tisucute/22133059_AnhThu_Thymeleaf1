...
import vn.anhthu.repository.CategoryRepository;
import vn.anhthu.services.CategoryService;
import org.thymeleaf.util.StringUtils;
import vn.anhthu.entity.CategoryEntity;
...
public class CategoryServiceImpl implements CategoryService 
{
	...
	public <S extends CategoryEntity> S save(S entity) {
		if(entity.getCategoryId() == null) {
			...
			Optional<CategoryEntity> opt = findById((Integer) entity.getCategoryId());
			if (opt.isPresent()) {
